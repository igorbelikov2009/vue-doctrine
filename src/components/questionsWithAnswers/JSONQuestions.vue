<template>
  <div>
    <button
      ...
      @click="isJSONQuestions = !isJSONQuestions"
      :class="{ 'general-issues__button_active': isJSONQuestions }"
    >
      Вопросы по JSON
    </button>

    <div v-if="isJSONQuestions">
      <div>
        <button
      ...
      <a class="general-issues__link" target="_blank" href=""></a>
